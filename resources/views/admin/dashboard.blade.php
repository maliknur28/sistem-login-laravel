...
<head>
  ...
  <title>OnlineStore | Dashboard</title>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <p class="brand-link justify-content-center">
    ...
    <div class="sidebar">
      ...
      <!-- <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <p class="d-block text-danger">{{ auth()->user()->email }}</p>
        </div>
      </div> -->
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <form action="/logout" method="post">
                  @csrf
                  <button type="submit" class="nav-link active btn btn-danger">Logout</button>
                </form>
              </li>
            </ul>
          </li>
